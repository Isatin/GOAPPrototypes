...
namespace std
{
    ...
    template <>
    struct hash<ExtendedGOAP::EConnective>
    {
        size_t operator () (ExtendedGOAP::EConnective Source) const noexcept
        {
            return std::hash<ExtendedGOAP::EConnective::Type>{}(Source.Get());
        }
    };
    ///////////////////////////////////////////////////////////////////////////////////////////////
}