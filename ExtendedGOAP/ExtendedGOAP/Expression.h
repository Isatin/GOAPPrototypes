...
namespace ExtendedGOAP
{
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    struct CFactInfo // Fact information composed of a fact index and a fact type
    {
        friend class CExpression;
    public:
        static bool Compare(const CFactInfo& Left, const CFactInfo& Right) { return Left.mIndex < Right.mIndex; }

    public:
        CFactInfo(const CFact& Fact);

        bool operator == (const CFactInfo&) const = default;

        EFactType GetType() const { return mType; }
        int16_t GetIndex() const { return mIndex; }
        void SetIndex(int16_t Value) { mIndex = Value; }

    private:
        int16_t mIndex = InvalidIndex;
    ...
    public:
        ...
        const CFactInfo& GrabFactInfo() const;
        // PREREQUISITE: This is a fact.
        EFactType GrabFactType() const;
        // PREREQUISITE: This is a fact.
        ...
        bool IsFact(int Index) const        { return IsFact() && mFactInfo.GetIndex() == Index; }
        bool IsOperation() const            { return mType == EOperand::operation; }
        bool IsOperation(int Index) const   { return IsOperation() && mOperationIndex == Index; }
    ...
    public:
        ...
        bool IsMatrixAddition()         const { return Operator == EOperator::matrixAddition; }
        bool IsMatrixSubtraction()      const { return Operator == EOperator::matrixSubtraction; }
        bool IsMatrixMultiplication()   const { return Operator == EOperator::matrixMultiplication; }
        bool IsScalarMultiplication()   const { return Operator == EOperator::scalarMultiplication; }
    ...
    class CExpression
    {
        ...
        friend class CMatrixExpression;
        friend class CRelation;
        friend class CSetExpression;
        friend struct STerm;
    public:
    ...
    public:
        ...
        CExpression(EOperator Operator, const std::vector<CFactInfo>& FactInfos, const std::vector<int>& OperationIndexes, CNumber Constant = CNumber::Null, int StartOperationIndex = 0);
        ...
        [[nodiscard]] CVariant Evaluate(const CStateBase& State) const;
