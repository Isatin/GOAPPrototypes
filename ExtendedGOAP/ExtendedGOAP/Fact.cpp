...
///////////////////////////////////////////////////////////////////////////////////////////////////
CMatrixFact::CMatrixFact(CFactDefinition& Owner, int Index, const std::string& Name, CNumber GapWeight)
    : CFact(Owner, Index, Name, EFactType::matrix)
    , mGapWeight(GapWeight)
{
    assert(GapWeight > 0.f);
    assert(GapWeight.IsFinite());
...
CFactAssignment CMatrixFact::operator = (const CMatrixFact& Right) const
{
    return CFactAssignment(*this, EOperator::nil, Right);
}

CFactAssignment CMatrixFact::operator = (const CMatrixExpression& Right) const
{
    return CFactAssignment(*this, EOperator::nil, Right);
}

void CMatrixFact::SetGapWeight(CNumber GapWeight)
{
    assert(GapWeight > 0.f);
    assert(GapWeight.IsFinite());
...
///////////////////////////////////////////////////////////////////////////////////////////////////
CSetFact::CSetFact(CFactDefinition& Owner, int Index, const std::string& Name, CNumber GapWeight)
    : CFact(Owner, Index, Name, EFactType::set)
    , mGapWeight(GapWeight)
{
    assert(GapWeight > 0.f);
    assert(GapWeight.IsFinite());
...
CFactAssignment CSetFact::operator = (const CSetFact& Right) const
{
    return CFactAssignment(*this, EOperator::nil, Right);
}

CFactAssignment CSetFact::operator = (const CSetExpression& Right) const
{
    return CFactAssignment(*this, EOperator::nil, Right);
}

void CSetFact::SetGapWeight(CNumber GapWeight)
{
    assert(GapWeight > 0.f);
    assert(GapWeight.IsFinite());
...
CMatrixFact* CFactDefinition::DefineMatrix(const std::string& Name, CNumber GapWeight)
{
    return Define<CMatrixFact>(Name, GapWeight);
}

CSetFact* CFactDefinition::DefineSet(const std::string& Name, CNumber GapWeight)
{
    return Define<CSetFact>(Name, GapWeight);
}
