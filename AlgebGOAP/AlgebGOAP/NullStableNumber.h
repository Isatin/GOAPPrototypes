...
namespace std
{
    ...
    template <>
    struct hash<AlgebGOAP::CNullStableNumber>
    {
        size_t operator () (const AlgebGOAP::CNullStableNumber& Source) const noexcept
        {
            return hash<AlgebGOAP::CNullStableNumber::BValue>{}(Source.Get());
        }
    };
    ///////////////////////////////////////////////////////////////////////////////////////////////
}